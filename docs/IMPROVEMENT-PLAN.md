...
| 인용 안의 여러 문단이 보존된다 | 편집하지 않은 인용은 채워졌다(2026-09-24). 인용 안을 편집하면 그 인용은 BlockNote가 직렬화하므로 문단이 합쳐진다 | 추가 검토 1의 "2단계 설계" 결과 |
...
| 20 | 추가 검토 9: 여러 문단 인용을 인용 블록 여럿으로 나누고 저장할 때 합치기 | `fix:` |
